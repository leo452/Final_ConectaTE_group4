...
class Test(TestCase):
    ...
    def test_comenzarEdicion(self):
        ...
        btn_tool = self.browser.find_element_by_id('herramienta_13_nombre') #Herramienta en estado de revision propia
        btn_tool.click()
    ...
    def test_adminAccessBorrador(self):
        ...
        btn_tool = self .browser.find_element_by_id('herramienta_16_nombre')  # Herramienta en estado en Borrador
        btn_tool.click()
    ...
    def test_rechazar_postulacion (self):
        ...
        btn_aceptar = self.browser.find_element_by_id('aceptarHerramienta-22')
        btn_aceptar.click()
    ...
    def test_aceptar_postulacion(self):
        ...
        btn_rechazar = self.browser.find_element_by_id('rechazarHerramienta-23')
        btn_rechazar.click()
