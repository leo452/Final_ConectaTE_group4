...
class Test(TestCase):
    ...
    def test_comenzarEdicion(self):
        ...
        btn_login = self.browser.find_element_by_id('herramienta_4_nombre') #Herramienta en estado de revision propia
        btn_login.click()

        btn_edicion = self.browser.find_element_by_id('comenzar_edicion') #Herramienta en estado de revision propia
        btn_edicion.click()
